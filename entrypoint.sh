...
streamlit run /projects/sub2audio/app.py --server.port=50003 --server.maxUploadSize=1 &
streamlit run /projects/ip-insight/app.py --server.port=50004 --server.maxUploadSize=1 &
